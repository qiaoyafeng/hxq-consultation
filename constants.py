...
IPT_QUESTIONS = [
    ...
    "有发生影响到情绪的事件吗？",
    "具体是什么时候发生的？",
    "虽然好像新的情况/最近的事情，让你很痛苦，但是其实是因为……（原本聚焦的问题）？",
    "我们的目标和之前是一致的……不过，我们可以试着去聊聊现在的问题……？",
    ...
    "好的。那接下来呢，我们会逐个讨论一下圈里的每个人。请你跟我讲讲你跟这个人的关系，ta是否有帮助或支持到你？以及你们的关系有没有令你不太满意的部分。你想先讲谁呢？【讨论人际关系清单】",
    "那目前你跟他的关系怎么样呢？",
    ...
    "到现在我们的治疗已经进行到初期阶段的尾声部分，下一次我们即将进入到中期阶段，在开始前，我们可能要共同探讨后面我们的治疗目标是怎样的，制定2-3个小的治疗目标。",
    "你最近一次吵架/发生不愉快是什么时候？",
    "对于吵架/不愉快的诉求是什么？",
    "首先，我会需要跟你介绍下什么是角色扮演，以及具体包括哪几个部分，首先你要去描述最近一周内发生的一件比较严重的事情，然后我会扮演你的角色，你扮演有冲突对象的角色（例如，妈妈），然后我们再去交换，你扮演你自己，我扮演冲突对象。然后在一起去探讨可以怎么去更改说话的方式？",
    ...
    "虽然好像新的情况让你很痛苦，但是其实是因为……（原本聚焦的问题），我们的目标和之前是一致的……不过，我们可以试着去聊聊现在的问题……",
